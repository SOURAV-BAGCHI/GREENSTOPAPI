    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatagoryDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name2 = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOTPStore", x => x.Phone);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "2", null, "ITAdmin", "ITADMIN" },
                    { "3", null, "OperationManager", "OPERATIONMANAGER" },
                    { "4", null, "Accounts", "ACCOUNTS" },
                    { "5", null, "DeliveryManager", "DELIVERYMANAGER" },
                    { "6", null, "Kitchen", "KITCHEN" },
